...
export const CurrentStory: React.FC = () => {
  ...
  return (
    <div data-testid="current-story" className="current-story p-5 bg-white border border-gray-200 rounded-lg mb-5 shadow-sm">
      <h2 data-testid="current-story-title" className="current-story-title text-2xl font-semibold text-gray-900 mb-3">
        {currentStory.title}
      </h2>
